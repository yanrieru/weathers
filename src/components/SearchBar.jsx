...
export default function SearchBar({ onSearch, defaultValue = "" }) {
  ...
  return (
     <motion.form
      ...
      className="flex w-full max-w-xl gap-2 bg-white/20 border border-white/20 backdrop-blur-lg shadow-xl rounded-full px-4 py-2"
    ...
    >
      ...
      <input
        ...
        placeholder="Cari kota, wilayah, dunia..."
        className="flex-1 px-4 py-2 bg-transparent text-gray-900 placeholder-gray-500 focus:outline-none"
      />
      <button
        type="submit"
        className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-4 py-3 rounded-full"
      >
        Cari
      </button>
      </div>
